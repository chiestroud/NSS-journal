  ...
  array.forEach((april) => {
    ...
    <h5 class="card-title">${april.date}</h5>
      <div class="card-body marchInfo middle">
        <h6 id="card-date">Comments from ${april.date}'s class</h6>
        <p>${april.notes}</p>
        <button class="btn edit-btn" data-toggle="modal" data-target="#formModal" title="Edit ${april.date}" id="update-apr-btn--${april.firebaseKey}"><i id="update-apr-btn--${april.firebaseKey}" class="fas fa-edit fa-lg"></i></button>
